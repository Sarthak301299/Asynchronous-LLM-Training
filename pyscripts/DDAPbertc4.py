...
def main():
    ...
    #Get Dataset online
    #train_dataset = load_dataset_split("allenai/c4", "en", split='train[:3%]')
    ...
    #tokenized_train_dataset = train_dataset.map(tokenize_function, batched=True, num_proc=32, remove_columns=['text','timestamp','url'])
