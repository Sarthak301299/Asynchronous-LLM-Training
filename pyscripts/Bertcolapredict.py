...
def main():
    ...
    config = Config(dataloaderprocs=5,batch_size=16,epochs=4,learning_rate=5e-5)
    #Get Model Online
    ...
    #tokenized_val_dataset.save_to_disk("/mnt/storage/sarthak.joshi/tokenized_sst2_validation")
    #tokenized_test_dataset.save_to_disk("/mnt/storage/sarthak.joshi/tokenized_sst2_test")
    tokenized_train_dataset = load_from_disk("/mnt/storage/sarthak.joshi/tokenized_cola_train")
    #tokenized_test_dataset = load_from_disk("/mnt/storage/sarthak.joshi/tokenized_sst2_test")
